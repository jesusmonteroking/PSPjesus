...
if __name__ == '__main__':
    ...
    handler = SignalHandler(stopper, workers)   #stopper (un evento que se utiliza para indicar a los hilos que deben detenerse) y la lista de workers (los hilos que están realizando el trabajo).
    signal.signal(signal.SIGINT, handler)       #Ctrl+C en la terminal d elinux
...
"""
En resumen, el manejador de señales garantiza que cuando el usuario
presiona Ctrl+C, el programa termine de manera ordenada deteniendo
los hilos y saliendo del programa sin dejar tareas pendientes
"""